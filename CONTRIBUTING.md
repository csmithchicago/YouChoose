# Contributing to YouChoose

All contribution no matter the size is welcome and encouraged! YouChoose is still a very new project and so any contributions are greatly appreciated. Anything from spelling and grammar mistakes to implementing new state of the art research methods is welcomed.
